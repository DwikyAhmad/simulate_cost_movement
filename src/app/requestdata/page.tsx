    ...
    return (
        <div className="min-h-screen bg-white p-3 md:p-6">
            <div className="max-w-6xl mx-auto space-y-6">
                {/* Header */}
                <div className="bg-white border-b border-gray-300 p-4 md:p-6">
                    <div className="flex flex-col space-y-4 md:space-y-0 md:flex-row md:items-center md:justify-between">
                        <div className="flex flex-col space-y-3 md:space-y-0 md:flex-row md:items-center md:gap-4">
                            <Button
                                onClick={() => (window.location.href = "/")}
                                variant="outline"
                                className="flex items-center gap-2 rounded-none border-2 border-gray-300 bg-white text-black hover:bg-gray-100 w-fit"
                            >
